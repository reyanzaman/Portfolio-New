...
export default function Artist() {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: (
        <Image
          ...
          alt="Freelancer"
          src={
            "https://res.cloudinary.com/dreac336r/image/upload/v1725816717/Portfolio/freelancer_logo.png"
          }
        ></Image>
      ),
    ...
    },
    {
      ...
      icon: (
        <Image
          ...
          alt="Artstation"
          src={
            "https://res.cloudinary.com/dreac336r/image/upload/v1725815065/Portfolio/artstation_icon.png"
          }
        ></Image>
      ),
    ...
    },
    {
      ...
      href: "https://drive.google.com/file/d/17kC-At15B7KL3qac6hYrfYPIakA2xBNw/view?usp=drive_link",
    },
    {
      title: "Contact",
      ...
      <div className="h-full w-full p-8 lg:pt-10 pb-12 bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:60px_60px]">
        <div className="flex lg:flex-row flex-col justify-center items-center lg:mb-20 mb-12">
          <div className="flex flex-col">
            ...
            <h1 className="lg:text-2xl text-base p-2">
              Created With Top of The Line Tools
            </h1>
          </div>
          <Compare
        ...
        <div className="flex lg:flex-row flex-col justify-center items-center lg:mb-20 mb-12">
          ...
          <div className="flex flex-col pb-8 lg:px-6 order-1 lg:order-2">
            ...
            <h1 className="lg:text-2xl text-base p-2">
              For Advertisement, Games, Promotion & More{" "}
            </h1>
          </div>
        </div>

        <div className="lg:mb-20 mb-10 lg:pt-10">
          <h1 className="lg:text-3xl text-base pb-1">
        ...
        <h1 className="lg:text-3xl text-base pt-1">
          Professional tools helps create high quality products
        </h1>
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          professional merchandise designs or templates that will help you stand
          out from the competition. Below, you will find some of the merchandise
          designs that I have created for my client.
        </p>
        <Image
  ...
  return (
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          <span className="font-bold text-neutral-200">
            Branded packaging plays a powerful role in shaping how people
        ...
        <Image
          src="https://res.cloudinary.com/dreac336r/image/upload/v1764269654/ScrewDriver_Bits_Mockup_publal.png"
        ...
        />
        <Image
          src="https://res.cloudinary.com/dreac336r/image/upload/v1764269653/ScrewDriver_Bits_Outer_Brown_Mockup_jq6brf.png"
          alt="Packaging design"
          height="500"
          width="500"
          className="md:w-1/2 md:h-1/2 h-full w-full mx-auto object-contain pt-8"
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          They are an effective way to showcase your products and services and
          attract new customers. I can help you create eye-catching and
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          They are an effective way to showcase your products and services and
          attract new customers. I can help you create eye-catching and
          professional banners and posters that will help you stand out from the
          competition. Below, you will find some of the banners and posters that
          I have designed for my clients.
        </p>
        <Image
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          They are an effective way to showcase your products and services and
          attract new customers. I can help you create elegant and professional
          menus and catalogues that will help you stand out from the
          competition. Below, you will find some of the menus and catalogues
          that I have designed for my clients.
        </p>
        <Image
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          It is a vital part of any marketing strategy and can help you reach a
          wider audience and increase brand awareness. I can help you create
          eye-catching and engaging social media posts that will help you
          connect with your audience and drive engagement. Below, you will find
          some of the social media posts that I have designed for my clients.
        </p>
        <Image
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          appreciation for their hard work. I can help you create elegant and
          professional certificates that will help you recognize and reward your
          achievers.
        </p>
        <Image
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          They are an effective way to showcase your products and services and
          attract new customers. I can help you create eye-catching and
          professional mockups that will help you stand out from the
          competition.
        </p>
        <Image
          src="https://res.cloudinary.com/dreac336r/image/upload/v1734039955/Portfolio/mockup_cartoon_box.png"
  ...
  return (
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          <span className="font-bold text-neutral-200">
            3D models and animations are a great way to bring your ideas to
            life.
          </span>{" "}
    ...
    <>
      ...
      >
        <p className="text-neutral-400 text-base md:text-2xl font-sans max-w-3xl mx-auto">
          ...
          graphics that will help you create a memorable gaming experience. I
          can help you create high-quality 2D game art that will help you bring
          your game to life. Below, you will find some of the 2D game art that I
          have created for my clients.
        </p>
        <Image
...
const data = [
  ...
  },
  {
    ...
    title: "Showcase your branded packaging.",
    src: "https://res.cloudinary.com/dreac336r/image/upload/v1764269356/Mockup_fbxhnr.png",
